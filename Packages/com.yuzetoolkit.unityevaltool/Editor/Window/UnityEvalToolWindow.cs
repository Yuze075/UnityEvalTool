...
namespace YuzeToolkit
{
    internal sealed class UnityEvalToolWindow : EditorWindow
    {
        private const string StyleSheetPath =
            "Packages/com.yuzetoolkit.unityevaltool/Editor/Window/UnityEvalToolWindow.uss";
        ...
        private void CreateGUI()
        {
            ...
            if (styleSheet == null)
                throw new MissingReferenceException($"UnityEvalTool workbench stylesheet is missing at '{StyleSheetPath}'.");
