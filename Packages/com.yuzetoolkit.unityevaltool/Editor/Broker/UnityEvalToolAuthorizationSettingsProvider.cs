...
namespace YuzeToolkit
{
    ...
    {
        private const string SettingsPath = "Project/YuzeToolkit/UnityEvalTool";
        ...
        public static SettingsProvider CreateProvider()
        {
            ...
            {
                label = "UnityEvalTool",
                keywords = new HashSet<string>(new[] { "UnityEvalTool", "Broker", "MCP", "CLI", "Token", "Player" }),
        ...
        private static void Build(VisualElement root)
        {
            ...
            var title = new Label("UnityEvalTool Authorization");
            ...
            var apply = new Button(() =>
            {
                try
                {
                    ...
                    Undo.RecordObject(asset, "Configure UnityEvalTool token");
            ...
            var clear = new Button(() =>
            {
                ...
                Undo.RecordObject(asset, "Clear UnityEvalTool token");
                asset.ClearToken();
                EditorUtility.SetDirty(asset);
                AssetDatabase.SaveAssets();
            ...
            requireToken.RegisterValueChangedCallback(evt =>
            {
                try
                {
                    ...
                    Undo.RecordObject(asset, "Change UnityEvalTool token requirement");
